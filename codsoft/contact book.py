...
def initial_phonebook():
    rows = int(input('Please enter the initial number of contacts: '))
    cols = 5
    phone_book = []
    print(phone_book)
    for i in range(rows):
...
def remove_existing(pb):
    query = str(input("Please enter the contact name you want to remove: "))
    temp = 0
...
def search_existing(pb):
    ...
    if choice == 1:
        ...
        query = str(input("Please enter the email-id of the contact you want to search: "))
        for i in range(len(pb)):
            if query == pb[i][2]:
                check = i
                temp.append(pb[i])
    elif choice == 4:
        query = str(input("Please enter the DOB of the contact you want to search: "))
        for i in range(len(pb)):
            if query == pb[i][3]:
                check = i
                temp.append(pb[i])
    elif choice == 5:
        query = str(input("Please enter the Category(Family/Friends/Work/Others) of the contact you want to search: "))
        for i in range(len(pb)):
            if query == pb[i][4]:
                check = i
                temp.append(pb[i])
